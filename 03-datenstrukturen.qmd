...
Stattdessen führen wir den sogenannten `Pipe`-Operator (geschrieben `%>%`) als neue Schreibweise an. Man kann sich seine Funktion so vorstellen, dass er alles, was auf der linken Seite von ihm steht, nimmt und dem, was auf der rechten Seite steht, übergibt. Wir wollen den vorherigen Codeblock einfacher schreiben:
